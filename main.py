...
if __name__ == "__main__":
    ...
    # - `discord.Intents.default()` provides common intents like guilds, members.
    # - `intents.message_content = True` is necessary to read message content for prefix commands.
    ...
    intents.guilds = True
    intents.message_content = True # IMPORTANT: This intent is required for prefix commands to work!
